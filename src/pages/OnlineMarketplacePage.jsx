...
export default function OnlineMarketplacePage() {
  ...
  const capabilities = [
    {
      title: 'Storefront Setup & Onboarding',
      icon: Globe,
      desc: 'Seamless seller registration, brand registry approval, and catalog category setup across Amazon, Shopify Plus, eBay & Flipkart.',
      deliverables: ['Amazon Brand Registry', 'Shopify Store Onboarding', 'Category Approval Setup', 'Multi-Storefront Launch']
    },
    {
      title: 'Product Cataloging & SEO',
      icon: Layers,
      desc: 'High-converting listing copy, search keyword optimization, image enhancement, and A+ premium content creation.',
      deliverables: ['A+ Content & Graphics', 'Search Keyword Indexing', 'High-Res Product Editing', 'Bullet Point Optimization']
    },
    {
      title: 'Automated Inventory & Order Sync',
      icon: RefreshCw,
      desc: 'Real-time multi-channel inventory synchronization, automated order tracking, and stock-out prevention frameworks.',
      deliverables: ['Real-Time Inventory Sync', 'Multi-Warehouse Logistics', 'Stock-Out Alert Alerts', 'Order Status Tracking']
    },
    {
      title: 'Review & Seller Health Management',
      icon: Star,
      desc: 'Proactive buyer support, review monitoring, seller account rating protection, and buyer dispute resolution.',
      deliverables: ['Account Health Defense', 'Buyer Review Monitoring', 'Dispute Resolution Desk', '99.8% Order SLA']
    }
  ];
    ...
    <div className="bg-slate-50 text-slate-900 min-h-screen">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden bg-gradient-to-b from-[#18253c] via-[#e2ebf7] to-[#f8fafc]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center space-x-2 text-xs font-bold text-slate-300 uppercase tracking-widest mb-10">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-slate-400" />
            <span className="text-white">Online Marketplace</span>
          </div>
          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex items-center space-x-2 px-5 py-1.5 rounded-md bg-[#0c1529] text-white text-xs font-extrabold uppercase tracking-widest shadow-lg border border-white/10">
              ...
              <span>E-Commerce Scaling Vertical</span>
            </div>
          </div>
          ...
          <div className="text-center max-w-4xl mx-auto space-y-6">
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-light text-slate-900 tracking-tight leading-tight">
              Online Marketplace Integration & Growth
            </h1>
            <p className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto font-normal">
              Expand multi-channel revenue streams with automated storefront setup, listing SEO, and real-time inventory management across Amazon & Shopify.
            </p>
            ...
            <div className="bg-gradient-to-br from-slate-900 via-[#0b1730] to-slate-950 rounded-3xl p-8 sm:p-12 text-white shadow-2xl space-y-8 border border-cyan-500/30">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-800 pb-6">
                <div>
                  <span className="text-xs font-black uppercase text-cyan-400 tracking-widest block mb-1">
                    Multi-Channel Storefront & Inventory Framework
                  </span>
                  <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
                    Marketplace Integration & Seller Health Blueprint
                  </h3>
                </div>
                <div className="px-4 py-2 rounded-xl bg-cyan-500/10 border border-cyan-400/30 text-xs font-extrabold text-cyan-300 shrink-0">
                  SLA Guaranteed: 99.8% Inventory Sync
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-slate-900/90 p-6 rounded-2xl border border-slate-800 space-y-3">
                  ...
                  <h4 className="font-extrabold text-base text-white">Automated Storefront Launch</h4>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Brand registry verification, GTIN exemption handling, category gating approvals, and custom storefront design.
                  </p>
                </div>
                ...
                <div className="bg-slate-900/90 p-6 rounded-2xl border border-slate-800 space-y-3">
                  ...
                  <h4 className="font-extrabold text-base text-white">A+ Listing SEO & Graphics</h4>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Keyword-indexed title/bullet optimization, 3D infographic rendering, lifestyle photo editing, and premium brand store design.
                  </p>
                </div>
                ...
                <div className="bg-slate-900/90 p-6 rounded-2xl border border-slate-800 space-y-3">
                  ...
                  <h4 className="font-extrabold text-base text-white">Real-Time Sync & Health Defense</h4>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Bi-directional inventory sync across Amazon FBA, Shopify Plus, eBay, stock-out alert triggers, and 24/7 seller metric protection.
                  </p>
                </div>
              </div>
              ...
              <div className="pt-4 flex flex-wrap items-center justify-between gap-4 border-t border-slate-800 text-xs text-slate-300 font-medium">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Platforms Supported: Amazon FBA, Shopify Plus, Flipkart, eBay, Walmart</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-400" />
                  <span>Automated Stock-Out Prevention & Order Fulfillment Desk</span>
                </div>
              </div>
      ...
      <div id="capabilities" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl mb-16 border border-slate-200 group">
          <img 
            src="/assets/online_marketplace_main.jpg" 
            alt="Suntech E-Commerce Marketplace Operations Team"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent flex flex-col justify-end p-6 sm:p-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl text-white">
              <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                <div className="text-2xl font-black text-[#00a3e0]">99.8%</div>
                <div className="text-[11px] text-slate-200 font-medium">Inventory Sync Accuracy</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                <div className="text-2xl font-black text-emerald-400">10,000+</div>
                <div className="text-[11px] text-slate-200 font-medium">Listings Optimized</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                <div className="text-2xl font-black text-white">4.9 / 5</div>
                <div className="text-[11px] text-slate-200 font-medium">Average Seller Rating</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                <div className="text-2xl font-black text-[#00a3e0]">Global</div>
                <div className="text-[11px] text-slate-200 font-medium">Marketplace Channels</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#007cc3] via-[#00a3e0] to-[#007cc3] rounded-3xl p-8 sm:p-12 text-center space-y-6 shadow-2xl text-white">
          ...
          <h2 className="text-2xl sm:text-4xl font-black text-white">Scale Your Marketplace Sales Today</h2>
          <p className="text-sm sm:text-base text-slate-100 font-medium max-w-xl mx-auto">
            Get a tailored multi-channel onboarding proposal from our e-commerce specialists.
          </p>
          <div className="pt-2">
            <Link
              to="/support"
            ...
            >
              ...
              <span>Contact Marketplace Specialists</span>
            </Link>
          </div>
        </div>
