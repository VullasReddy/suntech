            ...
            <div className="bg-gradient-to-br from-slate-900 via-[#0b1730] to-slate-950 rounded-3xl p-8 sm:p-12 text-white shadow-2xl space-y-8 border border-cyan-500/30">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-800 pb-6">
                <div>
                  <span className="text-xs font-black uppercase text-cyan-400 tracking-widest block mb-1">
                    Growth Engine & Analytics Blueprint
                  </span>
                  <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
                    SEO, Paid Acquisition & ROAS Scaling Framework
                  </h3>
                </div>
                <div className="px-4 py-2 rounded-xl bg-cyan-500/10 border border-cyan-400/30 text-xs font-extrabold text-cyan-300 shrink-0">
                  Target ROAS: 3.8x+ Return On Ad Spend
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-slate-900/90 p-6 rounded-2xl border border-slate-800 space-y-3">
                  ...
                  <h4 className="font-extrabold text-base text-white">Technical SEO & Rank Acceleration</h4>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Page speed optimization, schema markup injection, competitive keyword matrix targeting, and organic link authority acquisition.
                  </p>
                </div>
                ...
                <div className="bg-slate-900/90 p-6 rounded-2xl border border-slate-800 space-y-3">
                  ...
                  <h4 className="font-extrabold text-base text-white">Multi-Channel PPC Ad Management</h4>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Precision Google Ads search/shopping campaigns, Meta paid social retargeting, and LinkedIn B2B decision-maker outreach.
                  </p>
                </div>
                ...
                <div className="bg-slate-900/90 p-6 rounded-2xl border border-slate-800 space-y-3">
                  ...
                  <h4 className="font-extrabold text-base text-white">Conversion Funnel & CRO Optimization</h4>
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Heatmap click behavior analysis, landing page A/B split testing, lead magnet funnels, and frictionless checkout optimization.
                  </p>
                </div>
              </div>
              ...
              <div className="pt-4 flex flex-wrap items-center justify-between gap-4 border-t border-slate-800 text-xs text-slate-300 font-medium">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Full Analytics Stack (Google Analytics 4, SEMrush, Ahrefs, Optimizely)</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-400" />
                  <span>Transparent Weekly Campaign Performance Dashboards</span>
                </div>
              </div>
